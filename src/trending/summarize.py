...
For each GitHub repository, write one thing:

intro_zh: 2-3 sentence Chinese introduction. Explain what this project is, what problem it solves, and who it is for.

Requirements:
- Use Simplified Chinese.
- Be objective, accurate, and concrete.
- Do not add marketing language.
- Do not mention visuals, images, banners, thumbnails, or illustration ideas.

Output ONLY a single JSON object with one key: intro_zh (string). No markdown fences, no extra text."""
